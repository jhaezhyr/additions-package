...
{
    static var defaultFixedFractionalDigitRange			= 0...7
    static var defaultFixedIntegerDigitRange				= 1...400
    static var defaultFixedSignificantDigitRange			= 0...400
    static var defaultScientificSignificantDigitRange	= 1...4
    static var defaultScientificZeroCutOff				= 1.0e-8
    static var defaultGeneralFixedPointRange				= -5...10
	
	static let sharedFormatter		= NumberFormatter()
	
	
    func	descriptionWithFormatter(_ formatter: NumberFormatter) -> String
	{
...
*/
    func	hexDescription(	_ prefix:			Bool	= true,
    ...
    func binaryDescription(	prefix:	Bool	= true,
									fillerDigits:	Bool	= false,
									uppercase:		Bool	= false	) -> String
	{
    ...
    func octalDescription(	_ uppercase:	Bool	= false,
    ...
    func descriptionWithRadix(	_ radix:		Int,
										prefix:		String	= "",
										uppercase:	Bool	= false	) -> String
	{
