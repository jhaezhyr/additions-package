...
extension String
{
	...
	public func	explodeByCharacter<T: Collection>(dividers: T, insertDividers: Bool = false) -> [String] where T.Iterator.Element == Character
	{
		var result:		[String] = []
		var building:	String = ""
	...
	public func split(_ dividers: [String], insertDividers: Bool = false) -> [String]
	{
...
/*	public subscript(index: Index) -> Character
	...
	public var isWhiteOrFiller:Bool
	{
		for c in self
		{
	...
	public var sentenceCase:	String
	{
	...
	public func	correctCaseWithWords(_ reference: [String], mustBeWholeWord: Bool = true) -> String
	{
		var result = self
		let characters = self
	...
	public func	removeTrailingWhitespace() -> String
	{
		var result = self
	...
	public func	removeLeadingWhitespace() -> String
	{
...
extension String
{
	...
	public func	characterIndexRange(_ x: Range<Int>) -> Range<String.Index>
	{
		...
		return myStart ..< index(myStart, offsetBy: x.length)
	}
